...
public class Seller_category_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView (R.layout.activity_seller_category_page);
        ...
        tShirts.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent = new Intent(Seller_category_activity.this, seller_add_new_product.class);
