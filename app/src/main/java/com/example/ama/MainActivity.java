...
import com.example.ama.Model.Users;
...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView wanna_be_seller;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wanna_be_seller=findViewById (R.id.wanna_be_seller);
        ...
        wanna_be_seller.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view)
            {
