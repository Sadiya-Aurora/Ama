...
public class Settings_user extends AppCompatActivity {
    ...
    private void updateOnlyUserInfo() {
        ...
        startActivity(new Intent (Settings_user.this, UserpageActivity.class));
        Toast.makeText(Settings_user.this, "Profile Info update successfully.", Toast.LENGTH_SHORT).show();
        finish();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data)
    {
        ...
        else
        {
            ...
            startActivity(new Intent(Settings_user.this, Settings_user.class));
            finish();
        }
    }
                ...
                public Object then(@NonNull Task task) throws Exception
                {
                    ...
                    .addOnCompleteListener(new OnCompleteListener<Uri> () {
                        ...
                        public void onComplete(@NonNull Task<Uri> task)
                        {
                            ...
                            {
                                progressDialog.dismiss();
                                Toast.makeText(Settings_user.this, "Error.", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
        }
